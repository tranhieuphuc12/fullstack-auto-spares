...
const AddProductModal = ({ onProductAdded }: AddProductModalProps) => {
    ...
    const handleAddProduct = async () => {
        ...
        // Upload images to Express
        const formData = new FormData();
        images.forEach((image) => {
            formData.append("images", image); // field name must match multer config
        });
        ...
        const productData = {
            ...
            car: selectedCar,
            brand: selectedBrand,
            images: imageUrls, // ✅ Now has the public image URLs
        };
