            ...
            <div key={product._id} className="bg-white rounded-2xl shadow-md overflow-hidden">
                <div className="relative group w-full h-48">
                    <Link href={`/products/${product._id}`} className="absolute inset-0">
                        <Image src={`/products/${thumbnail}`} alt={product.name} className="w-full h-full object-cover transform transition-transform duration-300 group-hover:scale-105" width={100} height={100} />
                    </Link>
